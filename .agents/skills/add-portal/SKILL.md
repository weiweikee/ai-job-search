...
version: 1.0.0
description: >
  Generates a job-portal search skill for your local market. Triggers on: /add-portal, add-portal, generate skill, custom job portal.
---
...
Do reconnaissance before writing any code. Use read_url_content (or `curl` via Bash) on the portal:
